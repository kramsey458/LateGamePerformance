...
2. Update every place the site states a changed fact:
   - Static release fallbacks: `grep -rn "0\.4\.29\|652e6f52" docs` (today's Latest is 0.4.29): `data-release="tag"`
   ...
   - Test counts (509 / 129 today): `index.html` `.proofs` and the `#status` list.
