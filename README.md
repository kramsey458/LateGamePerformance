...
- Preview 0.4.11 (pre-release; 0.4.10 has been played, 0.4.11's change has not): one checkbox on the settings page, **Incremental garbage collection**, and the tree search no longer measures the distance to every grown tree when the lumberjack flag is full; see [TECHNICAL.md](TECHNICAL.md).
